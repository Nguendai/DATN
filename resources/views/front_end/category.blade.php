...
<div id="main-container" class="container">
    ...
    <section class="products-list col-md-9 container">
     ...
     <ol class="breadcrumb">
      ...
      <li class="active"><font><font class="">{{$name_cate->name}}</font></font></li>
    </ol>
    ...
    <div class="product-info-box">
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
          <div class="thumbnail wow fadeInUp " data-wow-duration="1.6s" data-wow-delay="0" style="height: 350px">
            <div class="image">
              <img src="{!! url('uploads/products/'.$data->images) !!}" style="min-height: 300px" alt="product" class="img-responsive">
            </div>
            <div class="caption">
              ...
              <div class="price">
               <span class="price-new">{{$data->promo2}}</span>
